...
--]========================================================================]
--LibDialog identifier and MAJOR and the version MINOR
local MAJOR, MINOR = "LibDialog", 1.24
--Check if any LibDialog version was already loaded and only overwrite if
--this version here is newer
if _G[MAJOR] ~= nil then
    if _G[MAJOR].version and _G[MAJOR].version >= MINOR then return end
end
